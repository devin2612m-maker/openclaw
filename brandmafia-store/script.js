...
const products = [
  ...
  { name: 'Sonilex Vibe SLBS1811 Bluetooth Speaker', img: 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=400&fit=crop', price: '260', rating: '4.20', badge: 'New', desc: 'Sonilex Vibe SLBS1811 Bluetooth Speaker with 10W output. Balanced sound quality with clear vocals and smooth bass. Easy wireless pairing via Bluetooth. Compact and durable ABS body, ideal for indoor and outdoor use.' },
  { name: 'Portable Neck Fan - Bladeless 4000mAh', img: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&h=400&fit=crop', price: '499', rating: '3.80', desc: 'Portable Hands-Free Bladeless Neck Fan with 4000mAh rechargeable battery. USB charging, headphone design, 3 speed settings. Perfect for outdoor activities, gym, travel, and daily commute. Lightweight and comfortable wear.' },
  { name: 'G Speaker Lamp - 3 in 1 Bluetooth Speaker', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop', price: '1,299', rating: '5.00', badge: 'Hot', desc: 'Constellation Mart G Speaker Lamp - APP Control 3 in 1 Multi-Function Bluetooth Speaker with Wireless Fast Charging, RGB Light and Sunrise effect. Perfect for bedroom and bedside table. Premium ambient lighting with quality audio.' },
  { name: 'Buds Pro 3 TWS Bluetooth Earbuds', img: 'https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=400&h=400&fit=crop', price: '899', rating: '4.50', badge: 'Best', desc: 'Buds Pro 3 TWS in-Ear Bluetooth Earbuds with Dual Drivers. Premium glossy finish, deep bass, HD sound quality. Smart touch controls for calls, music and voice assistant. Lightweight and comfortable for all-day wear.' },
];
